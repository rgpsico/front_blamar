...
if (!isset($hotel_name) || $hotel_name === '') {
    ...
    if ($id > 0) {
        $sql = "SELECT inc_name, city_name FROM incentive.inc_program WHERE inc_id = $1 LIMIT 1";
...
<header>
    <div class="container">
        ...
        <div class="menu_interno">
            ...
            <a href="<?php echo h(app_url('pages/hotel/hotel_list.php')); ?>">
                <button type="button" style="cursor:pointer;">Back to Hotels</button>
            </a>
        </div>
    </div>
</header>
    ...
    <div class="container_max ct02">
        <div class="container">
            <div class="breadcrumb">
                ...
                <a href="<?php echo h(app_url('pages/hotel/hotel_list.php')); ?>">Hotel</a>
                <i class="material-icons">&#xe315;</i>
