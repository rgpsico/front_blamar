...
<div class="featurs_right">
    ...
    <div class="featurs_inner">
        <div class="selos">
            <img src="<?php echo htmlspecialchars(asset_url('img/selo-01.png'), ENT_QUOTES, 'UTF-8'); ?>" alt="">
            <img src="<?php echo htmlspecialchars(asset_url('img/selo-02.png'), ENT_QUOTES, 'UTF-8'); ?>" alt="">
        </div>
        <div class="avaliacao">
            <div class="avalia_01">
                <img src="<?php echo htmlspecialchars(asset_url('img/stars.png'), ENT_QUOTES, 'UTF-8'); ?>" alt="">
                <p><?php echo isset($star_rating) && $star_rating ? h($star_rating) : '-'; ?></p>
            </div>
            <div class="avalia_02">
                <img src="<?php echo htmlspecialchars(asset_url('img/icon_desc_hot_01.png'), ENT_QUOTES, 'UTF-8'); ?>" alt="">
