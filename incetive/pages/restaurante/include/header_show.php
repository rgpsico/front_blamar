...
// Busca nome e cidade do restaurante via tabela restaurants
$restaurant_name = '';
$city_name       = '';

$id = isset($_GET['id']) ? (int)$_GET['id'] : 0;
if ($id > 0) {
    $sql = "SELECT name, city_code FROM incentive.restaurants WHERE id = $1 LIMIT 1";
...
<head>
    ...
    <title><?php echo $restaurant_name !== '' ? h($restaurant_name) : 'Restaurant'; ?></title>
</head>
<body>
...
<header>
    <div class="container">
        ...
        <div class="menu_interno">
            ...
            <a href="<?php echo h(app_url('pages/restaurante/restaurante_list.php')); ?>">
                <button type="button" style="cursor:pointer;">Back to Restaurants</button>
            </a>
        </div>
    </div>
</header>
...
<section id="header_page">
    <div class="container">
        <div class="page_title">
            <h2>Restaurants</h2>
            <h3><?php echo $city_name !== '' ? h($city_name) : 'City'; ?>'s restaurants selection</h3>
        </div>
    ...
    <div class="container_max ct02">
        <div class="container">
            <div class="breadcrumb">
                ...
                <a href="<?php echo h(app_url('pages/restaurante/restaurante_list.php')); ?>">Restaurants</a>
                <i class="material-icons">&#xe315;</i>
                <a href=""><?php echo $city_name !== '' ? h($city_name) : 'City'; ?></a>
                <i class="material-icons">&#xe315;</i>
                <a href=""><?php echo $restaurant_name !== '' ? h($restaurant_name) : 'Restaurant'; ?></a>
            </div>
        </div>
    </div>
</section>
